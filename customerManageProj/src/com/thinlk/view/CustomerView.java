package com.thinlk.view;

import com.thinlk.bean.Customer;
import com.thinlk.service.CustomerList;
import com.thinlk.util.CMUtility;

import java.sql.SQLOutput;

/**
 * @author Thinlk
 * @create 2020-12-18 4:39 PM
 **/
public class CustomerView {
    private final CustomerList customerList = new CustomerList(10);

    public CustomerView() {
        Customer customer = new Customer("张三", '男', 23, "1234213223", "lp@gmail.com");
